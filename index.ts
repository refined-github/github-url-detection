...
export const isNewRepo = (url: URL | HTMLAnchorElement | Location = location): boolean => url.pathname === '/new' || /organizations\/\S+\b\/repositories\/new/.test(getCleanPathname(url));
